...
;
angular.module("angular-jsvat.templates", []).run(["$templateCache", function($templateCache) {$templateCache.put("jsvat_input.html","<label ng-class=\"jsvatLabelClassObj\" class=\"jsvat-input__block\"><input type=\"text\" ng-model=\"jsvatModel.value\" ng-class=\"jsvatInputClassObj\" class=\"jsvat-input__field\"/></label>");}]);